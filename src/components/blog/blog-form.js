...
import RichTextsEditor from "../forms/rich-text-editor";
...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://greenwoodc.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    handleSubmit(event) {
        axios({
            ...
            console.log("error in blog handleSubmit", Error);
        });
